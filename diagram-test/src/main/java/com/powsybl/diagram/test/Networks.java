...
public final class Networks {
    ...
    public static Network createTestCase11Network() {
        ...
        // first voltage level
        //
        VoltageLevel vl1 = createVoltageLevel(substation, "vl1", "vl1", TopologyKind.NODE_BREAKER, 225);
        ...
        //
        VoltageLevel vl2 = createVoltageLevel(substation, "vl2", "vl2", TopologyKind.NODE_BREAKER, 380);
