...
class Vector2DTest {
    ...
    void testSubtract() {
        ...
        v1.subtract(v2);
        double delta = 0.01;
        assertEquals(expected.getX(), v1.getX(), delta);
        assertEquals(expected.getY(), v1.getY(), delta);
    }
    ...
    void testUnitVector() {
        ...
        for (int i = 0; i < resultVectors.length; i++) {
            ...
            assertEquals(expectedVectors[i].getX(), resultVectors[i].getX(), delta);
            assertEquals(expectedVectors[i].getY(), resultVectors[i].getY(), delta);
        }
