...
public class BusTopologyTest extends AbstractCgmesVoltageLevelLayoutTest {
    ...
    protected void checkCoordinates(VoltageLevelGraph graph) {
        ...
        assertEquals(30, graph.getNodes().get(2).getVlX(), 0);
        assertEquals(100, graph.getNodes().get(2).getVlY(), 0);
        assertTrue(graph.getNodes().get(2).isRotated());
        assertEquals(160, graph.getNodes().get(3).getVlX(), 0);
        assertEquals(110, graph.getNodes().get(3).getVlY(), 0);
        assertTrue(graph.getNodes().get(3).isRotated());
        assertEquals(200, graph.getNodes().get(4).getVlX(), 0);
        assertEquals(20, graph.getNodes().get(4).getVlY(), 0);
    ...
    private void checkCoordinatesVl2(VoltageLevelGraph graph) {
        ...
        assertTrue(graph.getNodes().get(1).isRotated());
        assertEquals(200, graph.getNodes().get(2).getVlX(), 0);
        assertEquals(20, graph.getNodes().get(2).getVlY(), 0);
