...
public class GraphMetadataTest {
    ...
    public void test() throws IOException {
        ...
        metadata.addFeederValueMetadata(new FeederValueMetadata("id1", "id3", 20));
        ...
        assertEquals("id3", metadata2.getFeederValueMetadata("id1").getFeederNodeId());
        ...
        assertEquals("id3", metadata3.getFeederValueMetadata("id1").getFeederNodeId());
    }
