 ...
 */
public class TestLackVoltageInformation extends AbstractTestCaseRaw {
    ...
    public void testYes() {
        ...
        assertEquals(toString("/testLackVoltageInformationYes.svg"),
                toSVG(g, "/testLackVoltageInformationYes.svg", getRawLabelProvider(g), new BasicStyleProvider()));
    }
}
