...
public class TestSVGWriter extends AbstractTestCaseIidm {
    ...
    protected static VoltageLevelGraph createVoltageLevelGraph1() {
        VoltageLevelGraph g1 = VoltageLevelGraph.create(new VoltageLevelInfos("vl1", "vl1", 400));
        g1.setCoord(40, 20);
    ...
    private static VoltageLevelGraph createVoltageLevelGraph2() {
        VoltageLevelGraph g2 = VoltageLevelGraph.create(new VoltageLevelInfos("vl2", "vl2", 225));
        g2.setCoord(40, 20);
    ...
    private static VoltageLevelGraph createVoltageLevelGraph3() {
        VoltageLevelGraph g3 = VoltageLevelGraph.create(new VoltageLevelInfos("vl3", "vl3", 63));
        g3.setCoord(40, 20);
    ...
    private void createSubstationGraph() {
        ...
        VoltageLevelGraph g1ForSubstation = VoltageLevelGraph.create(vl1Infos);
        ...
        VoltageLevelGraph g2ForSubstation = VoltageLevelGraph.create(vl2Infos);
        ...
        VoltageLevelGraph g3ForSubstation = VoltageLevelGraph.create(vl3Infos);
    ...
    private void createZoneGraph() {
        ...
        VoltageLevelGraph vl11Graph = VoltageLevelGraph.create(vl11Infos);
        ...
        VoltageLevelGraph vl12Graph = VoltageLevelGraph.create(vl12Infos);
        ...
        VoltageLevelGraph vl21Graph = VoltageLevelGraph.create(vl21Infos);
