...
public class TestSVGWriter extends AbstractTestCaseIidm {
    ...
    protected static VoltageLevelGraph createVoltageLevelGraph1() {
        VoltageLevelGraph g1 = VoltageLevelGraph.createForVoltageLevelGraphDiagram(new VoltageLevelInfos("vl1", "vl1", 400));
        g1.setCoord(40, 20);
    ...
    private static VoltageLevelGraph createVoltageLevelGraph2() {
        VoltageLevelGraph g2 = VoltageLevelGraph.createForVoltageLevelGraphDiagram(new VoltageLevelInfos("vl2", "vl2", 225));
        g2.setCoord(40, 20);
    ...
    private static VoltageLevelGraph createVoltageLevelGraph3() {
        VoltageLevelGraph g3 = VoltageLevelGraph.createForVoltageLevelGraphDiagram(new VoltageLevelInfos("vl3", "vl3", 63));
        g3.setCoord(40, 20);
    ...
    private void createSubstationGraph() {
        ...
        VoltageLevelGraph g1ForSubstation = VoltageLevelGraph.create(vl1Infos, substG);
        g1ForSubstation.setCoord(40, 40);

        BusNode vl1Bbs1 = BusNode.create(g1ForSubstation, "vl1_bbs1", "vl1_bbs1");
        vl1Bbs1.setX(0);
        vl1Bbs1.setY(300);
        vl1Bbs1.setPxWidth(200);
        vl1Bbs1.setPosition(new Position(0, 1, 4, 0, null));
        g1ForSubstation.addNode(vl1Bbs1);
        BusNode vl1Bbs2 = BusNode.create(g1ForSubstation, "vl1_bbs2", "vl1_bbs2");
        vl1Bbs2.setX(280);
        vl1Bbs2.setY(300);
        vl1Bbs2.setPxWidth(200);
        vl1Bbs2.setPosition(new Position(6, 1, 6, 0, null));
        g1ForSubstation.addNode(vl1Bbs2);
        SwitchNode vl1D1 = new SwitchNode("vl1_d1", "vl1_d1", ComponentTypeName.DISCONNECTOR, false, g1ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl1D1.setX(220);
        vl1D1.setY(300);
        ...
        SwitchNode vl1D2 = new SwitchNode("vl1_d2", "vl1_d2", ComponentTypeName.DISCONNECTOR, false, g1ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl1D2.setX(270);
        vl1D2.setY(300);
        g1ForSubstation.addNode(vl1D2);
        ...
        FeederNode vl1Load1 = FeederInjectionNode.createLoad(g1ForSubstation, "vl1_load1", "vl1_load1");
        vl1Load1.setOrder(0);
        vl1Load1.setDirection(BusCell.Direction.TOP);
        vl1Load1.setX(40);
        vl1Load1.setY(80);
        g1ForSubstation.addNode(vl1Load1);
        SwitchNode vl1Bload1 = new SwitchNode("vl1_bload1", "vl1_bload1", ComponentTypeName.BREAKER, false, g1ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl1Bload1.setX(40);
        vl1Bload1.setY(180);
        g1ForSubstation.addNode(vl1Bload1);
        SwitchNode vl1Dload1 = new SwitchNode("vl1_dload1", "vl1_dload1", ComponentTypeName.DISCONNECTOR, false, g1ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl1Dload1.setX(40);
        vl1Dload1.setY(300);
        g1ForSubstation.addNode(vl1Dload1);
        ...
        vl1Trf1.setX(80);
        vl1Trf1.setY(500);
        g1ForSubstation.addNode(vl1Trf1);
        SwitchNode vl1Btrf1 = new SwitchNode("vl1_btrf1", "vl1_btrf1", ComponentTypeName.BREAKER, false, g1ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl1Btrf1.setX(80);
        vl1Btrf1.setY(400);
        g1ForSubstation.addNode(vl1Btrf1);
        SwitchNode vl1Dtrf1 = new SwitchNode("vl1_dtrf1", "vl1_dtrf1", ComponentTypeName.DISCONNECTOR, false, g1ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl1Dtrf1.setX(80);
        vl1Dtrf1.setY(300);
        g1ForSubstation.addNode(vl1Dtrf1);
        ...
        Feeder3WTLegNode vl1Trf2 = Feeder3WTLegNode.createForSubstationDiagram(g1ForSubstation, "vl1_trf2_one", "vl1_trf2", "vl1_trf2", Feeder3WTLegNode.Side.ONE);
        vl1Trf2.setOrder(2);
        vl1Trf2.setDirection(BusCell.Direction.TOP);
        vl1Trf2.setX(400);
        vl1Trf2.setY(80);
        g1ForSubstation.addNode(vl1Trf2);
        SwitchNode vl1Btrf2 = new SwitchNode("vl1_btrf2", "vl1_btrf2", ComponentTypeName.BREAKER, false, g1ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl1Btrf2.setX(400);
        vl1Btrf2.setY(180);
        g1ForSubstation.addNode(vl1Btrf2);
        SwitchNode vl1Dtrf2 = new SwitchNode("vl1_dtrf2", "vl1_dtrf2", ComponentTypeName.DISCONNECTOR, false, g1ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl1Dtrf2.setX(400);
        vl1Dtrf2.setY(300);
        g1ForSubstation.addNode(vl1Dtrf2);
        ...
        VoltageLevelGraph g2ForSubstation = VoltageLevelGraph.create(vl2Infos, substG);
        g2ForSubstation.setCoord(590, 40);

        BusNode vl2Bbs1 = BusNode.create(g2ForSubstation, "vl2_bbs1", "vl2_bbs1");
        vl2Bbs1.setX(0);
        vl2Bbs1.setY(300);
        vl2Bbs1.setPxWidth(200);
        vl2Bbs1.setPxWidth(200);
        vl2Bbs1.setPosition(new Position(0, 1, 6, 0, null));
        g2ForSubstation.addNode(vl2Bbs1);
        FeederNode vl2Gen1 = FeederInjectionNode.createGenerator(g2ForSubstation, "vl2_gen1", "vl2_gen1");
        vl2Gen1.setOrder(0);
        vl2Gen1.setDirection(BusCell.Direction.TOP);
        vl2Gen1.setX(50);
        vl2Gen1.setY(80);
        g2ForSubstation.addNode(vl2Gen1);
        SwitchNode vl2Bgen1 = new SwitchNode("vl2_bgen1", "vl2_bgen1", ComponentTypeName.BREAKER, false, g2ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl2Bgen1.setX(50);
        vl2Bgen1.setY(180);
        g2ForSubstation.addNode(vl2Bgen1);
        SwitchNode vl2Dgen1 = new SwitchNode("vl2_dgen1", "vl2_dgen1", ComponentTypeName.DISCONNECTOR, false, g2ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl2Dgen1.setX(50);
        vl2Dgen1.setY(300);
        g2ForSubstation.addNode(vl2Dgen1);
        ...
        vl2Trf1.setX(100);
        vl2Trf1.setY(500);
        g2ForSubstation.addNode(vl2Trf1);
        SwitchNode vl2Btrf1 = new SwitchNode("vl2_btrf1", "vl2_btrf1", ComponentTypeName.BREAKER, false, g2ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl2Btrf1.setX(100);
        vl2Btrf1.setY(400);
        g2ForSubstation.addNode(vl2Btrf1);
        SwitchNode vl2Dtrf1 = new SwitchNode("vl2_dtrf1", "vl2_dtrf1", ComponentTypeName.DISCONNECTOR, false, g2ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl2Dtrf1.setX(100);
        vl2Dtrf1.setY(300);
        g2ForSubstation.addNode(vl2Dtrf1);
        ...
        Feeder3WTLegNode vl2Trf2 = Feeder3WTLegNode.createForSubstationDiagram(g2ForSubstation, "vl2_trf2_one", "vl2_trf2", "vl2_trf2", Feeder3WTLegNode.Side.TWO);
        vl2Trf2.setOrder(2);
        vl2Trf2.setDirection(BusCell.Direction.TOP);
        vl2Trf2.setX(160);
        vl2Trf2.setY(80);
        g2ForSubstation.addNode(vl2Trf2);
        SwitchNode vl2Btrf2 = new SwitchNode("vl2_btrf2", "vl2_btrf2", ComponentTypeName.BREAKER, false, g2ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl2Btrf2.setX(160);
        vl2Btrf2.setY(180);
        g2ForSubstation.addNode(vl2Btrf2);
        SwitchNode vl2Dtrf2 = new SwitchNode("vl2_dtrf2", "vl2_dtrf2", ComponentTypeName.DISCONNECTOR, false, g2ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl2Dtrf2.setX(160);
        vl2Dtrf2.setY(300);
        g2ForSubstation.addNode(vl2Dtrf2);
        ...
        VoltageLevelGraph g3ForSubstation = VoltageLevelGraph.create(vl3Infos, substG);
        g3ForSubstation.setCoord(890, 40);

        BusNode vl3Bbs1 = BusNode.create(g3ForSubstation, "vl3_bbs1", "vl3_bbs1");
        vl3Bbs1.setX(0);
        vl3Bbs1.setY(300);
        vl3Bbs1.setPxWidth(200);
        vl3Bbs1.setPosition(new Position(0, 1, 6, 0, null));
        g3ForSubstation.addNode(vl3Bbs1);
        FeederNode vl3Capa1 = FeederInjectionNode.createCapacitor(g3ForSubstation, "vl3_capa1", "vl3_capa1");
        vl3Capa1.setOrder(0);
        vl3Capa1.setDirection(BusCell.Direction.TOP);
        vl3Capa1.setX(40);
        vl3Capa1.setY(80);
        g3ForSubstation.addNode(vl3Capa1);
        SwitchNode vl3Bcapa1 = new SwitchNode("vl3_bcapa1", "vl3_bcapa1", ComponentTypeName.BREAKER, false, g3ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl3Bcapa1.setX(40);
        vl3Bcapa1.setY(180);
        g3ForSubstation.addNode(vl3Bcapa1);
        SwitchNode vl3Dcapa1 = new SwitchNode("vl3_dcapa1", "vl3_dcapa1", ComponentTypeName.DISCONNECTOR, false, g3ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl3Dcapa1.setX(40);
        vl3Dcapa1.setY(300);
        g3ForSubstation.addNode(vl3Dcapa1);
        ...
        Feeder3WTLegNode vl3Trf2 = Feeder3WTLegNode.createForSubstationDiagram(g3ForSubstation, "vl3_trf2_one", "vl3_trf2", "vl3_trf2", Feeder3WTLegNode.Side.THREE);
        vl3Trf2.setOrder(1);
        vl3Trf2.setDirection(BusCell.Direction.TOP);
        vl3Trf2.setX(150);
        vl3Trf2.setY(80);
        g3ForSubstation.addNode(vl3Trf2);
        SwitchNode vl3Btrf2 = new SwitchNode("vl3_btrf2", "vl3_btrf2", ComponentTypeName.BREAKER, false, g3ForSubstation, SwitchNode.SwitchKind.BREAKER, false);
        vl3Btrf2.setX(150);
        vl3Btrf2.setY(180);
        g3ForSubstation.addNode(vl3Btrf2);
        SwitchNode vl3Dtrf2 = new SwitchNode("vl3_dtrf2", "vl3_dtrf2", ComponentTypeName.DISCONNECTOR, false, g3ForSubstation, SwitchNode.SwitchKind.DISCONNECTOR, false);
        vl3Dtrf2.setX(150);
        vl3Dtrf2.setY(300);
        g3ForSubstation.addNode(vl3Dtrf2);
    ...
    private void createZoneGraph() {
        ...
        VoltageLevelGraph vl11Graph = VoltageLevelGraph.create(vl11Infos, s1Graph);
        ...
        VoltageLevelGraph vl12Graph = VoltageLevelGraph.create(vl12Infos, s1Graph);
        ...
        VoltageLevelGraph vl21Graph = VoltageLevelGraph.create(vl21Infos, s1Graph);
