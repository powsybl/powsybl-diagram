...
public class Feeder3WTLegNode extends FeederTwtLegNode {
    ...
    protected Feeder3WTLegNode(String id, String name, String equipmentId, Side side, VoltageLevelInfos myVoltageLevelInfos, VoltageLevelInfos otherSideVoltageLevelInfos) {
