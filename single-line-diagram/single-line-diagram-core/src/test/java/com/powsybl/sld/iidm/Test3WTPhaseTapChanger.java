...
class Test3WTPhaseTapChanger extends AbstractTestCaseIidm {
    ...
    void testVoltageLevelGraph3wtWithPhaseTagChanger() {
        ...
        VoltageLevelGraph voltageLevelGraph = graphBuilder.buildVoltageLevelGraph("VL_132");
        voltageLevelGraphLayout(voltageLevelGraph);

        assertEquals(toString("/Test3WTPhaseTapChangerVoltageLevel1Leg.svg"),
                toSVG(voltageLevelGraph, "/Test3WTPhaseTapChangerVoltageLevel1Leg.svg"));
        twt.getLeg2()
                .newPhaseTapChanger()
                .setTapPosition(1)
        ...
        graphBuilder = new NetworkGraphBuilder(network);
        // Build substation graph and run layout
        voltageLevelGraph = graphBuilder.buildVoltageLevelGraph("VL_132");
        voltageLevelGraphLayout(voltageLevelGraph);

        assertEquals(toString("/Test3WTPhaseTapChangerVoltageLevel2Legs.svg"),
                toSVG(voltageLevelGraph, "/Test3WTPhaseTapChangerVoltageLevel2Legs.svg"));
        twt.getLeg3()
                .newPhaseTapChanger()
                .setTapPosition(1)
        ...
        assertEquals(toString("/Test3WTPhaseTapChangerVoltageLevel3Legs.svg"),
                toSVG(voltageLevelGraph, "/Test3WTPhaseTapChangerVoltageLevel3Legs.svg"));
    }
}
