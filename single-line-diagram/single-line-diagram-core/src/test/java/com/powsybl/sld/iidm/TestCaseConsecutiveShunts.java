...
class TestCaseConsecutiveShunts extends AbstractTestCaseIidm {
    ...
    void test() throws IOException {
        ...
        assertEquals(toString("/consecutive_shunts.svg"), toSVG(g, "/consecutive_shunts.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, getDefaultDiagramStyleProvider(), getDefaultDiagramLegendProvider()));
    }
