...
class AnchorPointTest {
    ...
    void rotationTest() {
        ...
        AnchorPoint rotatedAnchorPoint1 = anchorPoint1.transformAnchorPoint(Orientation.LEFT, SldComponent.Transformation.ROTATION);
        ...
        AnchorPoint rotatedAnchorPoint2 = anchorPoint2.transformAnchorPoint(Orientation.LEFT, SldComponent.Transformation.ROTATION);
        ...
        AnchorPoint rotatedAnchorPoint3 = anchorPoint2.transformAnchorPoint(Orientation.DOWN, SldComponent.Transformation.ROTATION);
        ...
        AnchorPoint rotatedAnchorPoint4 = anchorPoint1.transformAnchorPoint(Orientation.UP, SldComponent.Transformation.ROTATION);
        ...
        AnchorPoint transformAnchorPoint = anchorPoint1.transformAnchorPoint(Orientation.LEFT, SldComponent.Transformation.NONE);
        assertEquals(anchorPoint1, transformAnchorPoint);
        AnchorPoint flipAnchorPoint = anchorPoint1.transformAnchorPoint(Orientation.DOWN, SldComponent.Transformation.FLIP);
