...
class TestSVGWriter extends AbstractTestCaseIidm {
    ...
    public void setUp() {
        ...
        legendProvider = new DefaultLegendProvider(Network.create("empty", ""), svgParameters);
    }

    @Test
    void testVl1() {
        assertEquals(toString("/vl1.svg"),
                toSVG(g1, "/vl1.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testVl1CssExternalImported() {
        ...
        assertEquals(toString("/vl1_external_css.svg"),
                toSVG(g1, "/vl1_external_css.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testVl1CssExternalNoImport() {
        ...
        assertEquals(toString("/vl1_external_css_no_import.svg"),
                toSVG(g1, "/vl1_external_css_no_import.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }

    @Test
    void testVl2() {
        assertEquals(toString("/vl2.svg"),
                toSVG(g2, "/vl2.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }

    @Test
    void testVl3() {
        assertEquals(toString("/vl3.svg"),
                toSVG(g3, "/vl3.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testSubstation() {
        ...
        assertEquals(toString("/substation.svg"),
                toSVG(substG, "/substation.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new NominalVoltageStyleProvider(), legendProvider));
    }
    ...
    void testSubstationArrowSymmetry() {
        ...
        assertEquals(toString("/substation_feeder_arrow_symmetry.svg"),
                toSVG(substG, "/substation_feeder_arrow_symmetry.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testSubstationNoFeederInfos() {
        ...
        assertEquals(toString("/substation_no_feeder_values.svg"),
                toSVG(substG, "/substation_no_feeder_values.svg", componentLibrary, layoutParameters, svgParameters, labelNoFeederInfoProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testVl1Optimized() {
        ...
        assertEquals(toString("/vl1_optimized.svg"),
                toSVG(g1, "/vl1_optimized.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testVl2Optimized() {
        ...
        assertEquals(toString("/vl2_optimized.svg"),
                toSVG(g2, "/vl2_optimized.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testVl3Optimized() {
        ...
        assertEquals(toString("/vl3_optimized.svg"),
                toSVG(g3, "/vl3_optimized.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testSubstationOptimized() {
        ...
        assertEquals(toString("/substation_optimized.svg"),
                toSVG(substG, "/substation_optimized.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testWriteZone() {
        ...
        assertEquals(toString("/zone.svg"),
                toSVG(zGraph, "/zone.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testStraightWires() {
        ...
        assertEquals(toString("/vl1_straightWires.svg"),
                toSVG(g1, "/vl1_straightWires.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testTooltip() {
        ...
        assertEquals(toString("/vl1_tooltip.svg"),
                toSVG(g1, "/vl1_tooltip.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testMultiLineTooltip() {
        ...
        assertEquals(toString("/vl1_multiline_tooltip.svg"),
                toSVG(g1, "/vl1_multiline_tooltip.svg", componentLibrary, layoutParameters, svgParameters, diagramLabelMultiLineTooltipProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testLabelOnAllNodes() {
        ...
        assertEquals(toString("/label_on_all_nodes.svg"),
                toSVG(g1, "/label_on_all_nodes.svg", componentLibrary, layoutParameters, svgParameters, diagramLabelSameNodeProvider, new BasicStyleProvider(), legendProvider));
    }
    ...
    void testWithGreyFrameBackground() {
        ...
        assertEquals(toString("/with_frame_background.svg"),
                toSVG(g1, "/with_frame_background.svg", componentLibrary, layoutParameters, svgParameters, labelProvider, styleProvider, legendProvider));
    }
}
