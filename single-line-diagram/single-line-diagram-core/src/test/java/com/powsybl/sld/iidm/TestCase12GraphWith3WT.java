...
class TestCase12GraphWith3WT extends AbstractTestCaseIidm {
    ...
    void testNodesInfosNominalVoltageStyle() {
        ...
        assertEquals(toString("/TestCase12GraphWithNodesInfosNominalVoltage.svg"),
                toSVG(g1, "/TestCase12GraphWithNodesInfosNominalVoltage.svg", new ConvergenceComponentLibrary(), layoutParameters, svgParameters, getDefaultDiagramLabelProvider(), new NominalVoltageStyleProvider(), getDefaultDiagramLegendProvider()));
    }
    ...
    void testNodesInfosTopologicalStyle() {
        ...
        assertEquals(toString("/TestCase12GraphWithNodesInfosTopological.svg"),
                toSVG(g1, "/TestCase12GraphWithNodesInfosTopological.svg", new ConvergenceComponentLibrary(), layoutParameters, svgParameters, getDefaultDiagramLabelProvider(), new TopologicalStyleProvider(network), getDefaultDiagramLegendProvider()));
    }
