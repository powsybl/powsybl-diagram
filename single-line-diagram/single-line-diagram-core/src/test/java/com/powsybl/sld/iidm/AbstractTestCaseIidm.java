...
public abstract class AbstractTestCaseIidm extends AbstractTestCase {
    ...
    public String toSVG(Graph g, String filename) {
        return toSVG(g, filename, componentLibrary, layoutParameters, svgParameters, getDefaultDiagramLabelProvider(), getDefaultDiagramStyleProvider(), getDefaultDiagramLegendProvider());
    }

    @Override
    public String toMetadata(Graph g, String filename) {
        return toMetadata(g, filename, componentLibrary, layoutParameters, svgParameters, getDefaultDiagramLabelProvider(), getDefaultDiagramStyleProvider(), getDefaultDiagramLegendProvider());
    }
    ...
    protected LegendProvider getDefaultDiagramLegendProvider() {
        return new DefaultLegendProvider(network, svgParameters);
    }
