...
public final class Networks {
    ...
    static Network createBusTopologyNetwork() {
    ...
    static Network createBusTopologyNetworkWith3WT() {
    ...
    static Network createNodeTopologyNetwork() {
    ...
    static Network createNodeTopologyNetworkWithInternalConnections() {
        Network network = Network.create("testCase1", "test");
    ...
    static Network createZoneDiagramNetwork() {
        ...
        network.newLine()
                ...
                .setB2(386E-6 / 2)
                .add();
        addZoneDiagramData(network);
        return network;
    }

    private static void addZoneDiagramData(Network network) {
