...
public abstract class AbstractDiagramDataExporter {
    ...
    protected String addDiagramObjectStyle(String name) {
        PropertyBag diagramObjectStyleProperties = new PropertyBag(List.of(CgmesDLModel.IDENTIFIED_OBJECT_NAME), true);
        diagramObjectStyleProperties.setClassPropertyNames(List.of(CgmesDLModel.IDENTIFIED_OBJECT_NAME));
