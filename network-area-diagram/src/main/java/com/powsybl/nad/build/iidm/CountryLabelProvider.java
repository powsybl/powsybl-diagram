...
public interface CountryLabelProvider {
     ...
     * @return the voltage level legend
     */
     ...
     * @param two
     * @return Optional EdgeInfo for the connection
     */
    Optional<EdgeInfo> getCountryEdgeInfo(Country country1, Country country2, List<Line> lines, List<TieLine> tieLines, List<HvdcLine> hvdcLines, BranchEdge.Side two);
