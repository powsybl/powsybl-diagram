...
public class NodesThread implements Runnable {
    ...
    private AbstractRepulsionForce repulsion;
    private double barnesHutTheta;
    private double gravity;
    private AbstractRepulsionForce gravityForce;
    private double scaling;

    public NodesThread(Node[] nodes, int from, int to, boolean barnesHutOptimize, double barnesHutTheta, double gravity, AbstractRepulsionForce gravityForce, double scaling, Region rootRegion, AbstractRepulsionForce repulsionForce) {
        this.nodes = nodes;
        this.from = from;
        this.to = to;
        this.rootRegion = rootRegion;
        this.barnesHutOptimize = barnesHutOptimize;
        this.repulsion = repulsionForce;
