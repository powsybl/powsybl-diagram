 ...
 * the License.
 */
package com.powsybl.sld.force.layout.gephi.graph.impl.utils;
...
public final class LongPacker {
     ...
     * @param valueParam the long value
     * @return the number of bytes written
     * @throws IOException if an error occurs with the stream
     */
    public static int packLong(DataOutput os, long valueParam) throws IOException {
     ...
     * @throws IOException if an error occurs with the stream
     */
    public static int packLong(byte[] ba, long valueParam) throws IOException {
        long value = valueParam;
        if (value < 0) {
            throw new IllegalArgumentException("negative value: v=" + value);
        }
     ...
     *
     * @param ba byte array
     * @param indexParam index in ba
     * @return the long value
     */
    public static long unpackLong(byte[] ba, int indexParam) {
        long result = 0;
     ...
     * @throws IOException if an error occurs with the stream
     */
    public static int packInt(DataOutput os, int valueParam) throws IOException {
